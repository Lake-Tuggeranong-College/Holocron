...
> [!important] Learning Outcomes: By completing this tutorial, you will be able to:
> 
> - Perform database schema mutations to extend existing tables for new transactional status fields.
> - Implement strict session gates to ensure private invoice data is only visible to the respective purchaser or an authorised administrator.
> - Construct clean helper functions for data masking to defend sensitive customer credit card details on screen.
> - Implement administrative state controllers that alter relational row statuses using secure query updates.
...
## Explanation: Relational Status Flags, Multi-Tier Views, and Defensive Data Masking
...
# Database Initialising and Seeding
...
==TODO== Put this before invoicing to introduce the concept for one page to handle admin view and for non-admins. Possibly before OrderForm/Checkout etc.
