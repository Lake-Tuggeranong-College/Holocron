...
- Each IP address is *unique*.
	- Not the whole story, more to come.
...
![](Copy%20of%2012%20IPv4%20Addressing_1.png)
...
![](Copy%20of%2012%20IPv4%20Addressing_2.png)

--

As shown in the figure\, assigning an IPv4 address to a host requires the following:

__IPv4 address__  \- This is the unique IPv4 address of the host\.

__Subnet mask__ - This is used to identify the network/host portion of the IPv4 address.
...
A  __subnet mask__  is used to determine the  <span style="color:#ff0000"> __network __ </span> and  <span style="color:#ff0000"> __host __ </span> portions\.



![](Copy%20of%2012%20IPv4%20Addressing_3.png)

---


# Q: What is the maximum last octet of an IP address?

![](Copy%20of%2012%20IPv4%20Addressing_4.png)

--


![](Copy%20of%2012%20IPv4%20Addressing_5.png)
...
The maximum value for an octet is 28 = 255 \(all bits set to 1\)\.

![](Copy%20of%2012%20IPv4%20Addressing_6.png)

--


![](Copy%20of%2012%20IPv4%20Addressing_7.png)

The maximum value for two octets is  216 =65\,536 \(all bits set to 1\)\.

---


# IPv4 Address Structure - The Subnet Mask (cont.)

The __ IPv4 subnet mask__  is used to differentiate the  <span style="color:#ff0000"> __network __ </span> portion from the host portion of an IPv4 address\. When an IPv4 address is assigned to a device\, the subnet mask is used to determine the network address of the device\. The network address represents all the devices on the same network\.

![](Copy%20of%2012%20IPv4%20Addressing_8.png)

Notice how the subnet mask is a consecutive sequence of  <span style="color:#ff0000"> __1__ </span>  bits followed by a consecutive sequence of 0 bits which indicates the host potion\.
...
A  __prefix length__  is a less cumbersome method used to identify a subnet mask address\.
...
![](Copy%20of%2012%20IPv4%20Addressing_9.png)

![](Copy%20of%2012%20IPv4%20Addressing_10.png)
...
To identify the  <span style="color:#ff0000"> __network __ </span> and  <span style="color:#ff0000"> __host __ </span> portions of an IPv4 address\, the subnet mask is compared to the IPv4 address bit for bit\, from  __left __ to  __right__ \.

The actual process used to identify the network and host portions is called ANDing\.

![](Copy%20of%2012%20IPv4%20Addressing_11.png)

Note that the subnet mask __ does not__  actually contain the network or host portion of an IPv4 address\, it just tells the computer where to look for the part of the IPv4 address that is the network portion and which part is the host portion\.

![](Copy%20of%2012%20IPv4%20Addressing_12.png)

---


# Q: Are these two IP4 address in the same network?
...
![](Copy%20of%2012%20IPv4%20Addressing_13.png)

__192\.168\.0__  __\.1__

__255\.255\.255__  __\.0__

__192\.168\.1__  __\.1__
...
![](Copy%20of%2012%20IPv4%20Addressing_14.png)
...
The actual process used to identify the network and host portions is called  __ANDing__ \.

![](Copy%20of%2012%20IPv4%20Addressing_15.png)
...
A logical AND is one of three Boolean operations used in Boolean or digital logic\. The other two are  __OR __ and  __NOT__ \. The AND operation is used in determining the network address\.

Logical AND is the comparison of two bits that produce the results shown below\. Note how only a  __1 AND 1 __ produces a  __1__ \. Any other combination results in a 0\.

__1__  AND  __1__  =  __1__

__0__  AND  __1__  =  __0__

__1__  AND __ 0__  =  __0__

__0__  AND __ 0__  =  __0__

![](Copy%20of%2012%20IPv4%20Addressing_16.png)
...
Subnet mask does not actually contain the network or host portion of an IPv4 address\, it just tells the computer where to look for the part of the IPv4 address that is the network portion and which part is the host portion\.

![](Copy%20of%2012%20IPv4%20Addressing_17.png)

---


# An example of ANDing Process

![](Copy%20of%2012%20IPv4%20Addressing_18.png)

---


# Classwork - ANDing to Determine the Network Address

Go to __ Classwork \- ANDing to Determine the Network Address__ \. Use the ANDing process to determine the network address \(in binary and decimal formats\)\. _[https://ahmedserver\.com/cisco/course/module8/8\.1\.2\.9/8\.1\.2\.9\.html](https://ahmedserver.com/cisco/course/module8/8.1.2.9/8.1.2.9.html)_

![](Copy%20of%2012%20IPv4%20Addressing_19.png)

---


# Q: What is the range of IP Addresses for this network?
...
![](Copy%20of%2012%20IPv4%20Addressing_0.png)
